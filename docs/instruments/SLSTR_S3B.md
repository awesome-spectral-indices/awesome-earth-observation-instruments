...
<div class="instrument-identity" aria-label="Instrument identifier">
  ...
  <code class="instrument-identity-value">SLSTR_S3B</code>
</div>

## Summary

<InstrumentSection instrument-id="SLSTR_S3B" section="summary" />
...
<InstrumentTabs instrument-id="SLSTR_S3B" />
...
instrument = xeo.instruments.SLSTR_S3B
