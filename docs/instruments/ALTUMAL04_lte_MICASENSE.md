...
> [!NOTE]
> This configuration applies to Altum cameras with serial numbers beginning with AL04 or lower. Imaging extension values and GSD describe the multispectral imagers at 120 m above ground level. The thermal imager has a 57 degree HFOV, 44.3 degree VFOV, 1.77 mm focal length, and 0.81 m GSD at 120 m. MicaSense identifies Altum as discontinued but does not provide an exact retirement date.
