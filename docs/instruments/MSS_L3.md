...
<div class="instrument-identity" aria-label="Instrument identifier">
  ...
  <code class="instrument-identity-value">MSS_L3</code>
</div>

## Summary

<InstrumentSection instrument-id="MSS_L3" section="summary" />

<InstrumentTabs instrument-id="MSS_L3" />
...
instrument = xeo.instruments.MSS_L3
